...
<fmt:message bundle="${loc}" key="local.go_out_profile" var="go_out_profile" />
<style type="text/css">
</style>
...
<body>
	...
	<c:if test="${user!=null}">
		<ul>
			<li><a href="Controller?command=go_to_user_page">${go_profile}</a></li>
			 <br />
			<li><a href="Controller?command=log_out">${go_out_profile}</a></li>
		</ul>
	</c:if>
