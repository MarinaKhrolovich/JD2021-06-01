...
public class ConnectionPool {
	...
	private ConnectionPool() {
		...
		DBResourceManager dbResourceManagerUser = DBResourceManager.getInstance();
		this.driverName = dbResourceManagerUser.getValue(DBParameter.DB_DRIVER);
		this.url = dbResourceManagerUser.getValue(DBParameter.DB_URL);
		this.user = dbResourceManagerUser.getValue(DBParameter.DB_USER);
		this.password = dbResourceManagerUser.getValue(DBParameter.DB_PASSWORD);
		try {
			this.poolSize = Integer.parseInt(dbResourceManagerUser.getValue(DBParameter.DB_POOLSIZE));
